...
export class GetTopicsRequest extends jspb.Message { 
    ...
    getTab(): src_protos_topic_topic_pb.Tab;
    setTab(value: src_protos_topic_topic_pb.Tab): GetTopicsRequest;
...
export namespace GetTopicsRequest {
    export type AsObject = {
        page: number,
        tab: src_protos_topic_topic_pb.Tab,
        limit: number,
        mdrender: string,
    }
}
...
export class GetTopicsResponse extends jspb.Message { 
    clearDataList(): void;
    getDataList(): Array<src_protos_topic_topic_pb.Topic>;
    setDataList(value: Array<src_protos_topic_topic_pb.Topic>): GetTopicsResponse;
    addData(value?: src_protos_topic_topic_pb.Topic, index?: number): src_protos_topic_topic_pb.Topic;
...
export namespace GetTopicsResponse {
    export type AsObject = {
        dataList: Array<src_protos_topic_topic_pb.Topic.AsObject>,
        success: boolean,
    }
}
...
export class GetTopicByIdResponse extends jspb.Message { 
    ...
    hasData(): boolean;
    clearData(): void;
    getData(): src_protos_topic_topic_pb.Topic | undefined;
    setData(value?: src_protos_topic_topic_pb.Topic): GetTopicByIdResponse;
...
export namespace GetTopicByIdResponse {
    export type AsObject = {
        data?: src_protos_topic_topic_pb.Topic.AsObject,
        success: boolean,
    }
}
